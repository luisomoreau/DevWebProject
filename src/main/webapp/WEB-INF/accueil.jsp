            ...
            <div class="row selection-blocks">
                <div class="shell4">
                    <div class="block">
                        ...
                        <p class="center">
                            <a href="requalification" class="button-blue">En savoir plus</a>
                        </p>
                    </div>
                </div>
                <div class="shell4">
                    <div class="block">
                        ...
                        <p class="center">
                            <a href="requalification" class="center button-blue">En savoir plus</a>
                        </p>
                    </div>
                </div>
                <div class="shell4">
                    <div class="block">
                        ...
                        <p>
                            <a href="materiel-incendie" class="button-blue">En savoir plus</a>
                        </p>
                    </div>
                </div>
            </div>
